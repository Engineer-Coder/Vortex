...
export const GameProvider = ({ children }) => {
  ...
  return (
    <GameContext.Provider value={{
      ...
      isDMMineUnlocked, isNextDepthHarvester, expandNode, triggerPrestige, 
      triggerDimensionalCollapse, buyUpgradeNode, buySingularityUpgrade, buyDMUpgrade, tapAnomaly, 
      isSeedLocked, setIsSeedLocked, runSeed, skipHarvester, consoleLog
    }}>
      {children}
...
function GameScreen() {
  ...
  // Optimized class resolver to completely prevent nested template tag compilation issues
  const getSingularityBtnClass = useCallback((id, cost) => {
    if (unlockedSingularityUpgrades.includes(id)) {
      return 'bg-pink-950/30 border border-pink-700 text-pink-400 cursor-default';
    }
    if (singularityShards >= cost) {
      return 'bg-pink-600 hover:bg-pink-500 text-white shadow-md active:scale-[0.98]';
    }
    return 'bg-[#2b2f48]/50 text-slate-500 cursor-not-allowed border border-slate-800/50';
  }, [unlockedSingularityUpgrades, singularityShards]);
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 rounded-xl bg-[#151724] border border-[#24283B] flex flex-col md:flex-row md:items-center justify-between gap-4 hover:bg-[#1a1c2d] transition-all duration-200">
                ...
                <button 
                  ...
                  className={`py-2.5 px-5 rounded-lg font-black text-xs uppercase tracking-widest transition-all duration-200 ${getSingularityBtnClass('seed_locker', 1)}`}
                >
              ...
              <div className="p-4 rounded-xl bg-[#151724] border border-[#24283B] flex flex-col md:flex-row md:items-center justify-between gap-4 hover:bg-[#1a1c2d] transition-all duration-200">
                ...
                <button 
                  ...
                  className={`py-2.5 px-5 rounded-lg font-black text-xs uppercase tracking-widest transition-all duration-200 ${getSingularityBtnClass('automated_prestige', 2)}`}
                >
              ...
              <div className="p-4 rounded-xl bg-[#151724] border border-[#24283B] flex flex-col md:flex-row md:items-center justify-between gap-4 hover:bg-[#1a1c2d] transition-all duration-200">
                ...
                <button 
                  ...
                  className={`py-2.5 px-5 rounded-lg font-black text-xs uppercase tracking-widest transition-all duration-200 ${getSingularityBtnClass('universal_catalyst', 3)}`}
                >
